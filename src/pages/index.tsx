  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience Book Story v1 - Unleashing the Power of Creativity for Book Creators with our Revolutionary SaaS Service"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Book Story v1 - Unleashing the Power of Creativity for Book Creators with our Revolutionary SaaS Service`}
            </Text>
            <Box
