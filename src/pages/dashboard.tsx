...
import { useSubscriptionCount, useBookCount, useChapterCount, useRoqPlatformUserProfiles } from 'lib/roq';

import { ChapterListPage as ShowCaseList } from 'pages/chapters';
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`chapters`} passHref legacyBehavior>
                  <Button
